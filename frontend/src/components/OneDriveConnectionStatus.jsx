...
export default function OneDriveConnectionStatus() {
  ...
  const handleDisconnect = async () => {
    ...
    const token = getEffectiveToken();
    try {
      await onedriveService.disconnect(token);
      setStatus({ connected: false, email: null, loading: false });
    } catch (err) {
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <div style={{ textAlign: "left" }}>
            <p style={{ margin: 0, fontSize: "0.875rem", fontWeight: 600, color: "var(--text-primary)" }}>OneDrive Connected</p>
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        ...
        <div style={{ textAlign: "left" }}>
          <p style={{ margin: 0, fontSize: "0.875rem", fontWeight: 600, color: "var(--text-primary)" }}>OneDrive Disconnected</p>
