...
export default function QuoteBlock({ attributes, onChange, isSelected }) {
  ...
  return (
    <blockquote className={`my-4 pl-5 border-l-4 border-indigo-500 relative ${isLarge ? "py-4 text-lg font-serif italic" : "py-2 text-sm italic"}`}>
      ...
      <div
        ...
        className="text-xs text-indigo-300 not-italic mt-2 outline-none font-sans font-semibold empty:before:content-['—_Add_citation...'] empty:before:text-gray-500"
